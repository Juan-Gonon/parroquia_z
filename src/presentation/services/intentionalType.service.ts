...
export class TipoIntencionService {
  ...
  public async getTipoIntencionById(id: number): Promise<any> {
    ...
    if (tipoIntencion == null) {
      throw CustomError.badRequest(
        'The requested Type of Intention was not found.'
      )
    }
    return tipoIntencion
  }
  ...
  public async getAllTipoIntenciones(
    ...
    try {
      ...
      const data = await prisma.tipointencion.findMany()
  ...
  public async createTipoIntencion(
    ...
    const tipoIntencionExists = await this.getTipoIntencionByName(
      createTipoIntencionDto.nombre
    )
    if (tipoIntencionExists) {
      throw CustomError.badRequest(
        'A Type of Intention with that name already exists.'
      )
    }
    try {
      ...
      throw CustomError.internalServer(
        'An error occurred while creating the Type of Intention.'
      )
    }
  }
  ...
  public async updateTipoIntencion(
    ...
    const tipoIntencionExists = await this.getTipoIntencionById(
      updateTipoIntencionDto.id
    )
    if (!tipoIntencionExists) {
      throw CustomError.badRequest(
        'The requested Type of Intention to update was not found.'
      )
    }
    ...
    try {
      ...
      throw CustomError.internalServer(
        'An error occurred while updating the Type of Intention.'
      )
    }
  }
  ...
  public async deleteTipoIntencion(id: number): Promise<any> {
    ...
    if (!tipoIntencionExists) {
      throw CustomError.badRequest(
        'The requested Type of Intention to delete was not found.'
      )
    }
    try {
      ...
      throw CustomError.internalServer(
        'An error occurred while deleting the Type of Intention.'
      )
    }
  }
}

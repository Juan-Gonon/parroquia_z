    ...
    router.post(
      ...
      [
        body(PARAMS_BODY.idFeligres)
          .notEmpty()
          .withMessage(validationMessages.required(PARAMS_BODY.idFeligres))
          .isInt()
          .withMessage(validationMessages.notInteger(PARAMS_BODY.idFeligres)),
        body(PARAMS_BODY.idEvento)
          .notEmpty()
          .withMessage(validationMessages.required(PARAMS_BODY.idEvento))
          .isInt()
          .withMessage(validationMessages.notInteger(PARAMS_BODY.idEvento)),
        body(PARAMS_BODY.idTipoIntencion)
          .notEmpty()
          .withMessage(validationMessages.required(PARAMS_BODY.idTipoIntencion))
          .isInt()
          .withMessage(
        ...
        body(PARAMS_BODY.idEstadoIntencion)
          .notEmpty()
          .withMessage(
            validationMessages.required(PARAMS_BODY.idEstadoIntencion)
          )
          .isInt()
          .withMessage(
        ...
        body(PARAMS_BODY.montoOfrenda)
          ...
          .isDecimal()
          .withMessage(validationMessages.notDecimal(PARAMS_BODY.montoOfrenda)),
        body(PARAMS_BODY.pagada)
          .optional()
          .isBoolean()
          .withMessage(validationMessages.notBoolean(PARAMS_BODY.pagada)),
        body(PARAMS_BODY.montoPagado)
          .optional({ checkFalsy: true })
          .isDecimal()
          .withMessage(validationMessages.notDecimal(PARAMS_BODY.montoPagado)),
        body(PARAMS_BODY.fechaPago)
          .optional({ checkFalsy: true })
          .isISO8601()
          .toDate()
          .withMessage(validationMessages.notDate(PARAMS_BODY.fechaPago)),
        ValidateFields.validate,
      ],
      controller.create
    )
